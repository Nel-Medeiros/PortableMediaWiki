...
The following is a list of at least some modules that you should export from English Wikipedia to an XML file. Just cut and paste this list into the list of files to be exported (you might want to try doing one by one, in case it times out doing a batch):
